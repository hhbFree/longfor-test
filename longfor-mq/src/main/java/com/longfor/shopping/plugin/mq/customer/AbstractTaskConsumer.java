...
import com.longfor.shopping.plugin.mq.queue.memery.TaskQueueMemory;
import com.longfor.shopping.plugin.mq.queue.memery.TaskQueuePriorityMemory;
import com.longfor.shopping.plugin.mq.storage.TaskStorageType;
